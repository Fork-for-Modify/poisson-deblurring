...
if __name__ == '__main__':
    ...
    # path
    src_path1 = 'results/physical_reteained_results/deblur_tmp_img01.png'
    src_path2 = 'results/physical_reteained_results/deblur_tmp_img01.png'
    dst_path = 'results/physical_reteained_results/deblur_final_img.png'
